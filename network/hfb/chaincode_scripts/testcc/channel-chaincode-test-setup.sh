...
#peer chaincode instantiate -o orderer.el-network.com:7050 -C $CHANNEL_NAME -n testcc -l node -v 5.5 -c '{"Args":[]}' -P "OR ('Org1MSP.member','Org2MSP.member','Org3MSP.member','Org4MSP.member')" --tls --cafile $CACERT_ORDERER
peer chaincode instantiate -o orderer.el-network.com:7050 -C $CHANNEL_NAME -n testcc -v 1.0 -c '{"Args":[]}' -P "OR ('Org1MSP.member','Org2MSP.member','Org3MSP.member','Org4MSP.member')" --tls --cafile $CACERT_ORDERER

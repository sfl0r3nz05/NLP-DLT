...
def locationSelection(location_list):
    ...
    and returns a list (e.g., ['Proximus']) which represents the selected locations. To do this, it sorts the dictionaries based on frequency. To select organizactions 

...
- The `proposeAgreementInitiation` method ([Proposal for start agreement](https://github.com/sfl0r3nz05/NLP-DLT/tree/main/chaincode#proposal-for-start-agreement)) set the *status* to `started_ra`.
- The `acceptAgreementInitiation` method ([Confirmation of Started Agreement](https://github.com/sfl0r3nz05/NLP-DLT/tree/main/chaincode#confirmation-of-started-agreement)) changes the *status* from `started_ra` to `started_ra_confirmation`.
- The first time execution of the method `proposeAddArticle` ([Proposal for add article](https://github.com/sfl0r3nz05/NLP-DLT/tree/main/chaincode#proposal-for-add-article)) changes the *status* from `started_ra_confirmation` to `ra_negotiating`.
- A new call to the `proposeAddArticle` method ([Proposal for add article](https://github.com/sfl0r3nz05/NLP-DLT/tree/main/chaincode#proposal-for-add-article)) maintains the *status* as `ra_negotiating`.
- A call to the `proposeUpdateArticle` method ([Proposal for update article](https://github.com/sfl0r3nz05/NLP-DLT/tree/main/chaincode#proposal-for-update-article)) maintains the *status* as `ra_negotiating`.
- A call to the `proposeDeleteArticle` method ([Proposal for delete article](https://github.com/sfl0r3nz05/NLP-DLT/tree/main/chaincode#proposal-for-delete-article)) maintains the *status* as `ra_negotiating`.
- When the `reachAgreement` method ([Proposal of Agreement Achieved](https://github.com/sfl0r3nz05/NLP-DLT/tree/main/chaincode#proposal-of-agreement-achieved)) is executed, it is verified that *status* at the *article* negotiation level is set to `transient_confimation` inspecting the *model* [LISTOFARTICLES](https://github.com/sfl0r3nz05/NLP-DLT/blob/main/chaincode/implementation/models.go#:~:text=JSONROAMINGAGREEMENT) then, the *status* of the [ROAMINGAGREEMNT](https://github.com/sfl0r3nz05/NLP-DLT/blob/main/chaincode/implementation/models.go#:~:text=type-,ROAMINGAGREEMNT) *struct* is set from `ra_negotiating` to `accepted_ra`.
- The `acceptReachAgreement` method([Confirmation of Agreement Achieved](https://github.com/sfl0r3nz05/NLP-DLT/tree/main/chaincode#confirmation-of-agreement-achieved)) changes the *status* from `accepted_ra` to `accepted_ra_confirmation`.
...
- It is set to `init` when the list that contains the *articles* is created by the `proposeAgreementInitiation` method ([Proposal for start agreement](https://github.com/sfl0r3nz05/NLP-DLT/tree/main/chaincode#proposal-for-start-agreement)).
- It is set to `articles_drafting` when the first article is created after the first execution of the `proposeAddArticle` method ([Proposal for add article](https://github.com/sfl0r3nz05/NLP-DLT/tree/main/chaincode#proposal-for-add-article)).
- When `acceptProposedChanges` mehtod ([Accept proposed changes](https://github.com/sfl0r3nz05/NLP-DLT/tree/main/chaincode#accept-proposed-changes)) is executed the chaincode verifies if all *articles* into the list have `accepted_changes` as *status*:
...
- If the *status* is `transient_confimation` and the `reachAgreement` method ([Proposal of Agreement Achieved](https://github.com/sfl0r3nz05/NLP-DLT/tree/main/chaincode#proposal-of-agreement-achieved)) is executed, the *status* changes to `end`.
- If the *status* is `transient_confimation` and the `proposeAddArticle` method ([Proposal for add article](https://github.com/sfl0r3nz05/NLP-DLT/tree/main/chaincode#proposal-for-add-article)), the `proposeUpdateArticle` method ([Proposal for update article](https://github.com/sfl0r3nz05/NLP-DLT/tree/main/chaincode#proposal-for-update-article)), or the `proposeDeleteArticle` method ([Proposal for delete article](https://github.com/sfl0r3nz05/NLP-DLT/tree/main/chaincode#proposal-for-delte-article)) are executed, the *status* returns to `articles_drafting`.
- A call to the `reachAgreement` method ([Proposal of Agreement Achieved](https://github.com/sfl0r3nz05/NLP-DLT/tree/main/chaincode#proposal-of-agreement-achieved)) implies the verification of the *status* of each *article* into the *model* [ARTICLE](https://github.com/sfl0r3nz05/NLP-DLT/blob/main/chaincode/implementation/models.go#:~:text=type-,ARTICLE).
- Whether all *articles* can be verified when the `reachAgreement` method ([Proposal of Agreement Achieved](https://github.com/sfl0r3nz05/NLP-DLT/tree/main/chaincode#proposal-of-agreement-achieved)) is executed, the *status* of the list is set to `end`.
...
- It is set to `added_article` when the [Proposal for add article](https://github.com/sfl0r3nz05/NLP-DLT/tree/main/chaincode#proposal-for-add-article) method is executed.
- It is set to `proposed_changes` when the methods [Proposal for update article](https://github.com/sfl0r3nz05/NLP-DLT/tree/main/chaincode#proposal-for-update-article), or [Proposal for delete article](https://github.com/sfl0r3nz05/NLP-DLT/tree/main/chaincode#proposal-for-delete-article) are executed.
- It is set to `accepted_changes` when the [Proposal for add article](https://github.com/sfl0r3nz05/NLP-DLT/tree/main/chaincode#proposal-for-add-article) method is executed.
